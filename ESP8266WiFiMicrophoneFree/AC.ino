...
void configPage_AC()
{
  ...
  else
  {
    ...
    //Your config
    //rev 1.2
    content += "<form method='get' action='' id='f3'><h2>Microphone Configuration</h2><fieldset>Audio Stream Bitrate<select size='1' name='b'>";

    content += "<option value='0'";
    if(ucWMBitrate == 0)
      content += " selected";
    content += ">60 Kbps</option>";
    
    content += "<option value='1'";
    if(ucWMBitrate == 1)
      content += " selected";
    content += ">70 Kbps</option>";
    
    content += "<option value='2'";
    if(ucWMBitrate == 2)
      content += " selected";
    content += ">80 Kbps</option>";

    content += "</select></fieldset><fieldset>Audio Stream Packet Length<select size='1' name='p'>";
    
    content += "<option value='0'";
    if(ucWMPacketLen == 0)
      content += " selected";
    content += ">5 Min</option>";
    
    content += "<option value='1'";
    if(ucWMPacketLen == 1)
      content += " selected";
    content += ">10 Min</option>";
    
    content += "<option value='2'";
    if(ucWMPacketLen == 2)
      content += " selected";
    content += ">30 Min</option>";
    
    content += "<option value='3'";
    if(ucWMPacketLen == 3)
      content += " selected";
    content += ">60 Min</option>";

    content += "</select></fieldset><fieldset>Audio Stream Software Amplitude<select size='1' name='a'>";
    ...
    content += "</select></fieldset><fieldset><input type='submit' value='Save' /></fieldset></form>";
